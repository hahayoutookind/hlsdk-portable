...
{
	return m_bomber != NULL;
}

inline CBasePlayer *CHLBot::GetBomber() const
{
	return (CBasePlayer *)(CBaseEntity *)m_bomber;
}

inline CBasePlayer *CHLBot::GetClosestVisibleFriend() const
{
	return (CBasePlayer *)(CBaseEntity *)m_closestVisibleFriend;
}

inline CBasePlayer *CHLBot::GetClosestVisibleHumanFriend() const
{
	return (CBasePlayer *)(CBaseEntity *)m_closestVisibleHumanFriend;
}
